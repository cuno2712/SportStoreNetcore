...
namespace WebApplication7.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(UserManager<ApplicationUser> useMng, SignInManager<ApplicationUser> signMng,
            IOptions<IdentityCookieOptions> identityCookieOptions, ILoggerFactory loggerFactory)
        {
            userManager = useMng;
        ...
        public async Task<IActionResult> Login(LoginModel loginModel)
        {
            ...
            {
                var result =
                    await signInManager.PasswordSignInAsync(loginModel.Name, loginModel.Password, loginModel.RememberMe,
                        false);
                if (result.Succeeded)
                {
